...
echo "  Additional useful flags:"
echo "    --auto-connect / -a    Attempt to connect to configured IP before showing menu (TUI only)."
echo "    --debug / -d           Enable TUI debug messages (device add/remove notifications)."
echo ""
echo "For help:"
